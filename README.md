...
## Automation
- In terms of Automation, First, I was able to I was able to link the Virtual Studio Project to the Virtual Studio Code Project. Then, I was able to push the Virtual Studio Code to my repository by going to the Source Control icon, clicking on Initialize Repository, and then pushing to the URL of my Github repository. 
- I was then able to use the Azure portal to help in Automation by deploying my app through Github Actions. I achieved this by going through the Deplyoment Center in the Azure Portal to find the automation option of Github. It then proceeded to create a Github Action worklfow with code to deploy my project on push in the master branch. 
- Currently, I am troubleshooting a runtime time when deploying the project automatically. I have done extensive research on the cause of my error message and have tried multiple solutions, with no success. I believe it is a .Net Framework issue of compatability. It seems to be a common issue with little to no standardized soloutions. I will continue to troubleshoot this problem in order to fully achieve automation. I plan on doing some more research and using a trial and error method like I have been doing. 
