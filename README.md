...
## Automation
- In terms of Automation, First, I was able to I was able to link the Virtual Studio Project to the Visrtual Studio Code Project. Then, I was able to push the Virtual Studio Code to my repository by going to the Source Control icon, clicking on Initialize Repository, and then pushing to the URL of my Github repository. 
